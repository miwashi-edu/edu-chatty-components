...
const hasWin = typeof window !== "undefined" && typeof window.sessionStorage !== "undefined";
...
function readAll() {
    ...
    for (let i = 0; i < window.sessionStorage.length; i++) {
        ...
        out.push({ key: k, value: window.sessionStorage.getItem(k) });
    }
    ...
    return (
        <div className={styles.section}>
            ...
            {filteredRows.length === 0 ? (
                <div className={styles.muted}>No sessionStorage items.</div>
            ) : (
